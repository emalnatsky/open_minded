...
class ResumeHelper:
    ...
    def session_config_from_resume_log(self, log: dict, resume_path: str) -> dict:
        ...
        config.setdefault("condition", log.get("tutorial_condition", self.d.CONDITION_CONTROL))
    ...
    def restore_runtime_state_from_log(self, log: dict):
        ...
        self.d.memory_review_requested = bool(log.get("memory_review_requested", False))
