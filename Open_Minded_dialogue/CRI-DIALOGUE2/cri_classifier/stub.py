...
INTENT_PATTERNS = [
    ...
    (re.compile(r"\b(?:nee,?\s*)?mijn (?:favoriete|lievelings|liefste|leukste) hobby is\b", re.IGNORECASE), "um_update"),
    ...
    (re.compile(
        ...
        r"wat weet jij|wat onthoud jij|wat herinner jij|wat heb jij|"
        r"kun je zeggen wat je (?:van|over) mij (?:weet|onthoudt?)|"
        r"kun je vertellen wat je (?:van|over) mij (?:weet|onthoudt?)|"
        r"zeg eens wat je (?:van|over) mij (?:weet|onthoudt?)|"
        r"laat eens zien|mag ik in je geheugen|mag ik in jouw geheugen|"
        r"mag ik je geheugen|mag ik jouw geheugen|kan ik je geheugen|"
        r"kan ik jouw geheugen|in je geheugen kijken|in jouw geheugen kijken|"
        r"geheugenboek|geheugen boek|"
        r"wat staat er|klopt het dat|weet je wat mijn|wat is mijn|"
        r"wat staat in je geheugen|wat staat in jouw geheugen|"
        r"wat onthoud je|wat heb je onthouden|heb je iets onthouden|"
        r"wat onthoudt je|wat onthoudt jij|wat heb je opgeslagen|"
        ...
        r"wat weet jij nog van mij|wat weet jij over mij|"
        r"wat weet je allemaal over mij|wat weet jij allemaal over mij)\b",
        re.IGNORECASE,
    ), "um_inspect"),
