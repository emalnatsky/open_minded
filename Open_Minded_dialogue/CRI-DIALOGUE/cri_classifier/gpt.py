...
# ── System prompt (change to dutch when done testing in english)─────────────────────────────────────────────────────────────

INTENT_SYSTEM_PROMPT = (
    "You are an intent classifier for a child-robot interaction system. "
    "A NAO robot called Leo is talking to an English child aged 8-11. "
    "The child speaks English. Classify what the child said into exactly one intent, "
