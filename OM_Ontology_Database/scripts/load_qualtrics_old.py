...
USAGE:
    python scripts/load_qualtrics_old.py path/to/export.csv
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        print("Usage: python scripts/load_qualtrics_old.py <path_to_csv> <source_label>")
        print("  e.g.: python scripts/load_qualtrics_old.py data/new.csv qualtrics_new")
        print("  e.g.: python scripts/load_qualtrics_old.py data/returning.csv qualtrics_returning")
        sys.exit(1)
    SOURCE = sys.argv[2]
    load_csv(sys.argv[1])